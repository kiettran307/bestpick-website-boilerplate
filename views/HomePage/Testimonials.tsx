...
const TESTIMONIALS = [
  {
    ...
    content: `Ánh sáng đi trước âm thanh, vì thế, con người ta trông có vẻ thông minh cho đến khi ta nghe họ phát biểu `,
    author: {
      name: 'Clyde Edwards',
  ...
  },
  {
    ...
    content: `Không phải vết thương nào cũng chảy máu. Và cũng không phải không chảy máu là không bị đau.`,
    author: {
      name: 'Jimmy Hunter',
  ...
  },
  {
    ...
    content: `Tiền không mua được tất cả nhưng không có tiền thì vất vả, thế thôi`,
    author: {
